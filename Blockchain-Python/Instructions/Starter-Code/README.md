# Unit 19 | Homework Assignment: Multi-Blockchain Wallet in Python
...
In this assignment, you will only need to get two coins working: Ethereum and Bitcoin Testnet.
...
- Test that you can run the `php derive ` script properly, using one of the examples on the repo's `README.md`
...
- Here is [constants.py](Starter-Code/constants.py) 

### Generate a Mnemonic

- Generate a new 12-word mnemonic using `hd-wallet-derive` or by using [bip39](https://iancoleman.io/bip39/).
...
![wallet-access-in-terminal](Images/access_key.jpg)
![wallet-derive](Images/wallet_derive.jpg)
...
- Screenshot the confirmation of the transaction. Since I did not prefund the BTC test account, the transaction shows insufficient funds
![btc-testkey-function](Images/BTC_key.jpg)
![btc-test](Images/BTC_test.jpg)
![btc-insufficient-fund-transaction](Images/insufficient_BTC.jpg)
...
![ETH-in-terminal](Images/ETH_transaction.jpg)
![ETH-mycrypto](Images/transaction_sent_ETH.jpg)
